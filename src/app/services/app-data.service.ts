...
export class AppDataService{
    private countries : Array<Country> = [
        ...
        {id: 10, name: "Normay", epiIndex: 78.04},
    ];
    ...
    updateCountry(updatedCountry: Country) : Observable<any>{
        let oldCountryIndex = this.countries.findIndex(c=>c.id==updatedCountry.id);
        this.countries.splice(oldCountryIndex,1,updatedCountry);
        return Observable.of({}).delay(2000);
    }
}